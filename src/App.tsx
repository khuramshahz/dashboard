...
export default function TopNav({ onToggleSidebar, onShowSystemLogs, onShowSecurityAudit, isMobile }: TopNavProps) {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-64 right-0 h-16 z-50 bg-gradient-to-r from-[#071225] to-[#030712] border-b border-[#0096FF]/20 flex items-center gap-4 px-4">
        <p className="text-sm md:text-base tracking-wide text-[#0096FF] truncate min-w-0 flex-1" style={{ paddingLeft: '40px' }}>
